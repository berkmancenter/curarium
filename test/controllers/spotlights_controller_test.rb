...
class SpotlightsControllerTest < ActionController::TestCase
  ...
  test "should create spotlight" do
    assert_difference('Spotlight.count') do
      post :create, spotlight: { body: @spotlight.body, records: @spotlight.records, title: @spotlight.title, type: @spotlight.type }
    end
  ...
  test "should update spotlight" do
    patch :update, id: @spotlight, spotlight: { body: @spotlight.body, records: @spotlight.records, title: @spotlight.title, type: @spotlight.type }
    assert_redirected_to spotlight_path(assigns(:spotlight))
  end
